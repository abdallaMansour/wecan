    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('month-or-day')->label(__('dashboard.month-or-day'))->default('--'),
                Tables\Columns\TextColumn::make('duration')->label(__('dashboard.duration'))->default('--'),
            ])
            ->filters([
                //
            ])
